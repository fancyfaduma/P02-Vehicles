...
public class CarControllerTest {
    ...
    public void updateCar() throws Exception {
        Car car_ = getCar();
        Details details = car_.getDetails();
        details.setModel("Ypppp");
        details.setMileage(349238);
        details.setExternalColor("black");
        details.setBody("prius");
        details.setEngine("I don't know");
        details.setFuelType("Electric");
        details.setModelYear(2033);
        details.setProductionYear(2044);
